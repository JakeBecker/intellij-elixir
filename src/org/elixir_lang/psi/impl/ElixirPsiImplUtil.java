...
public class ElixirPsiImplUtil {
                    ...
                    if (resolveResultCount == 0) {
                        ...
                        for (ResolveResult resolveResult : resolveResults) {
                            ...
                            if (resolveResultElement != null &&
                                    ...
                                    org.elixir_lang.psi.stub.type.call.Stub.isModular((Call) resolveResultElement)) {
    ...
    public static Call qualifierToModular(@NotNull QualifiableAlias qualifier,
        ...
        if (fullyResolvedQualifier instanceof Call) {
           ...
           if (org.elixir_lang.psi.stub.type.call.Stub.isModular(fullyResolvedQualifierCall)) {
